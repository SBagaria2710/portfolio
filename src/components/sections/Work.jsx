...
const LINK = ({ href, children }) => (
  <a href={href} target="_blank" rel="noopener noreferrer">{children}{EXT}</a>
);
      ...
      <div className="frame">
        ...
        <ul className="roles">
          ...
          <li className="role reveal">
            ...
            <div className="role__head">
              <h3 className="role__company">
                <LINK href="https://www.deel.com">Deel</LINK>
              </h3>
              <p className="role__title">Senior Software Engineer</p>
            </div>
            <div className="role__years">
              <b>Sep 2025 — Present</b>
              Remote
            </div>
          ...
          <li className="role reveal">
            ...
            <div className="role__head">
              <h3 className="role__company">
                <LINK href="https://www.hotstar.com">JioHotstar</LINK>
              </h3>
              <p className="role__title">Senior SDE 1</p>
            </div>
            <div className="role__years">
              <b>Apr 2024 — Sep 2025</b>
              Bengaluru
            </div>
            <p className="role__summary">
          ...
          <li className="role reveal">
            ...
            <div className="role__head">
              <h3 className="role__company">
                <LINK href="https://www.jiocinema.com">JioCinema</LINK>
              </h3>
              <p className="role__title">Software Development Engineer 2</p>
            </div>
            <div className="role__years">
              <b>Sep 2023 — Apr 2024</b>
              Bengaluru
            </div>
            <p className="role__summary">
            ...
            <div className="role__stack">
              ...
              <span className="chip">WCAG AA</span>
            </div>
          </li>
          ...
          <li className="role reveal">
            ...
            <div className="role__head">
              <h3 className="role__company">
                <LINK href="https://www.cars24.com">Cars24</LINK>
              </h3>
              <p className="role__title">Frontend Developer</p>
            </div>
            <div className="role__years">
              <b>Sep 2021 — Aug 2023</b>
              Bengaluru
            </div>
            <p className="role__summary">
          ...
          <li className="role reveal">
            ...
            <div className="role__head">
              <h3 className="role__company">
                <LINK href="https://talent500.co">Talent500</LINK>
              </h3>
              <p className="role__title">Software Engineer — Web (Contract)</p>
            </div>
            <div className="role__years">
              <b>Apr 2021 — Sep 2021</b>
              Remote
            </div>
            <p className="role__summary">
          ...
          <li className="role reveal">
            ...
            <div className="role__head">
              <h3 className="role__company">
                <LINK href="https://sequoia.com">Sequoia Consulting</LINK>
              </h3>
              <p className="role__title">Frontend Engineer</p>
            </div>
            <div className="role__years">
              <b>Aug 2019 — Apr 2021</b>
              Bengaluru
            </div>
            <p className="role__summary">
