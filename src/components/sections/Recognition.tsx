    ...
    <section id="recognition">
      <div className="frame">
        <div className="section-head reveal">
          ...
          <p className="section-kicker">the occasional gold star</p>
        </div>
        ...
        <div className="badges">
          ...
          <div className="badge reveal">
            <div className="crest">✦</div>
            <p className="name">Certificate of Appreciation</p>
            <p className="org">Team Shiksha</p>
            <p className="body">For managing the community and conducting Frontend Deep Dive and System Design sessions, helping students understand advanced topics.</p>
            <span className="yr">2022</span>
          </div>
        </div>
      </div>
