      ...
      <div className="frame">
        <div className="hero">
          ...
          <dl className="hero__stats">
            <div>
              <dt>Experience</dt>
              <dd>6+ yrs<small>in production systems</small></dd>
            </div>
            <div>
              <dt>Companies</dt>
              <dd>3+<small>Deel · JioHotstar · Cars24</small></dd>
            </div>
            <div>
              <dt>Stack</dt>
              <dd>JS/TS<small>+ React · Node · Vite</small></dd>
            </div>
            <div>
              <dt>Currently</dt>
              <dd>SSE<small>@ Deel · Remote</small></dd>
            </div>
          </dl>
        </div>
      </div>
