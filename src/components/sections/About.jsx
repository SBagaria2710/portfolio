const IMDb = ({ href, children }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" style={{ borderBottom: '1px dashed currentColor', color: 'inherit' }}>{children}</a>
);
      ...
      <div className="frame">
        ...
        <div className="about">
          ...
          <p className="b reveal">
            ...
            <a href="https://linktr.ee/shashwatb" target="_blank" rel="noopener noreferrer" style={{ borderBottom: '1px dashed currentColor' }}>
          ...
          <div className="currently__body">
            ...
            <dl>
              ...
              <dd>
                ...
                <IMDb href="https://www.imdb.com/title/tt6741278/">Invincible</IMDb>
                {' · '}
                <IMDb href="https://www.imdb.com/title/tt1190634/">The Boys</IMDb>
              </dd>
              <dt>Reading</dt>
              ...
              <dd>
                <span className="arrow">→</span>
                <a href="https://www.youtube.com/@PredictiveHistory" target="_blank" rel="noopener noreferrer" style={{ borderBottom: '1px dashed currentColor', color: 'var(--gold)' }}>
                  Predictive History Sessions
                </a>
              </dd>
              <dt>Podcasting</dt>
              <dd><span className="arrow">→</span>
                <a href="https://open.spotify.com/show/11XFJoppFmn2LGuSRYg5R1" target="_blank" rel="noopener noreferrer" style={{ borderBottom: '1px dashed currentColor', color: 'var(--gold)' }}>
