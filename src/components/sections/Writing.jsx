  ...
  return (
    <section id="writing">
      <div className="frame">
        ...
        <p style={{ marginTop: '28px', fontFamily: 'var(--mono)', fontSize: '13px', color: 'var(--ink-2)' }} className="reveal">
          <Link to="/blog" style={{ borderBottom: '1px dashed var(--ink-2)', paddingBottom: '1px' }}>All posts →</Link>
        </p>
      </div>
    </section>
  );
