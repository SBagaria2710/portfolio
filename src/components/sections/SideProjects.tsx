      ...
      <div className="frame">
        ...
        <div className="cards">
          <a className="card reveal" href="https://thebrightpause.com/" target="_blank" rel="noopener noreferrer">
            ...
            <p className="desc">A mindfulness publication offering short, guided pauses as an alternative to doomscrolling. Field notes, ~2-minute reads - designed to leave you a little lighter than the feed found you.</p>
